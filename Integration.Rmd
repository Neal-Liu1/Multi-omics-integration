...
```{r}
brca_selected_genes <- apply(assay(brca_data[['normalized_transcriptome_raw_counts']],'RUV_K8_on_HTseq_counts'),1 ,FUN = mad) >= 2.5
...
MOFA2::plot_factor(ov_mofa, factors = c(1:5), color_by = ov_metadata$subtype)
