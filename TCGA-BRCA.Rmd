...
plot_RLE(assay(data_methylation_complete_matched_samples,'M_values')[, 600:1100], data_methylation_complete_matched_samples@colData$platform[600:1100], ylimit = c(-5,5))
