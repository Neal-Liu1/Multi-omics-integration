...
```{r}
plot_count_map(proteome_normalized@colData$combined_batch, proteome_normalized@colData$subtypes, 1)

```

```{r}
plot_PCA(assay(proteome_normalized, 'raw_unshared_log_ratios'),'raw unshared proteome', proteome_normalized@colData$Median, 'medians', is_pca_obj = F, is_continuous = T)
```

```{r}
plot_PCA(assay(proteome_normalized, 'RUV_K8_on_raw_unshared_log_ratios'),'raw unshared proteome', proteome_normalized@colData$subtypes, 'medians', is_pca_obj = F, is_continuous = F)
```
