...
# Plot the density plots
ggplot(mapping = aes(x=calculated_singscore_purity$`number of count > 15 greater than 10% ncol`, fill=data_transcriptome1@colData$subtype)) +
  geom_density(alpha=0.5) + # alpha for transparency to see overlap
  labs(x="Tumor Purity", y="Density", fill="Tumor Subtype") +
...
OV_subtypes1$Confident_subtypes <- ifelse(OV_subtypes1$`1st&2nd_subtype_difference` > 0.5, 'yes', 'no')
