...
PRPS_confident_subtypes <- supervisedPRPS(se.obj=data_transcriptome1[,which(data_transcriptome1@colData$Confident_subtypes == 'yes')],
                       ...
                       uv.variables=c('lib_size','batch','Calculated_singscore_purity'),
...
```{r}
plot_linear_correlation(PRPS_confident_subtypes@assays@data@listData,
                        c('unnormalized','RUV-K4'),
                        log2(PRPS_confident_subtypes@colData$lib_size),
                        'libsize')
...
plot_vector_correlation(list(prcomp(t(assay(PRPS_confident_subtypes,'transcriptome_matrix1'))),
