...
View(scheirerRayHare(y=transcriptome_matrix2[1,], x1=patient_metadata$consensus_subtypes, x2 = patient_metadata$transcriptome_batch, type= 1))
View(kruskal.test(transcriptome_matrix2[1,], patient_metadata$transcriptome_batch))
