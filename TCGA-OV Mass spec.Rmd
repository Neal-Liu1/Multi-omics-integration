...
p2 <- ggplot(mapping = aes(x=log2(PRPS_confident_subtypes@colData$Calculated_singscore_purity),y=NCG_pca$V1))+
  geom_point(alpha=0.62, color= 'grey30') + # alpha for transparency to see overlap
  labs(y="PC1 of NCGs", 
       x="Purity") +
  theme_minimal()+
...
p2 <- ggplot(mapping = aes(x=log2(PRPS_confident_subtypes_raw_counts@colData$Calculated_singscore_purity),y=NCG_pca_raw_counts$V1))+
  geom_point(alpha=0.62, color= 'grey30') + # alpha for transparency to see overlap
  labs(y="PC1 of NCGs", 
       x="Purity") +
  theme_minimal()+
