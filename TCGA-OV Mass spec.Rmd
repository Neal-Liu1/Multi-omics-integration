...
OV_subtypes1$Confident_subtypes <- ifelse(OV_subtypes1$`1st&2nd_subtype_difference` > 0.6, 'yes', 'no')
...
transcript_subtype_purity_anova <- transcript_subtype_purity_anova[order(transcript_subtype_purity_anova[['Adj.PValue']]),]

ggplot(mapping=aes(x=transcript_subtype_purity_anova$Adj.PValue))+
...
plot_PCA(assay(data_transcriptome1,'transcriptome_matrix1')[which(transcript_subtype_purity_anova$Adj.PValue < 0.05),],'genes with high interaction between purity & subtype',data_transcriptome1@colData$subtype,'subtype')
